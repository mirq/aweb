...
#define __Assl_cleanup_WB(___base, ___assl) \
   LP1NR(0x1e, Assl_cleanup, struct Assl *, ___assl, a0,\
...
#define __Assl_connect_WB(___base, ___assl, ___sock, ___hostname) \
   LP3(0x30, long, Assl_connect, struct Assl *, ___assl, a0, long, ___sock, d0, UBYTE *, ___hostname, a1,\
   , (___base), IF_CACHEFLUSHALL, NULL, 0, IF_CACHEFLUSHALL, NULL, 0)
...
#define __Assl_geterror_WB(___base, ___assl, ___errbuf) \
   LP2(0x36, char *, Assl_geterror, struct Assl *, ___assl, a0, char *, ___errbuf, a1,\
   , (___base), IF_CACHEFLUSHALL, NULL, 0, IF_CACHEFLUSHALL, NULL, 0)
...
#define __Assl_write_WB(___base, ___assl, ___buffer, ___length) \
   LP3(0x3c, long, Assl_write, struct Assl *, ___assl, a0, char *, ___buffer, a1, long, ___length, d0,\
   , (___base), IF_CACHEFLUSHALL, NULL, 0, IF_CACHEFLUSHALL, NULL, 0)
