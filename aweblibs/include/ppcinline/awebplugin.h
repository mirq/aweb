...
#define __Initplugin_WB(___base, ___plugininfo) \
   LP1(0x1e, ULONG, Initplugin, struct Plugininfo *, ___plugininfo, a0,\
...
#define __Queryplugin_WB(___base, ___pluginquery) \
   LP1NR(0x24, Queryplugin, struct Pluginquery *, ___pluginquery, a0,\
   , (___base), IF_CACHEFLUSHALL, NULL, 0, IF_CACHEFLUSHALL, NULL, 0)
...
#define __Commandplugin_WB(___base, ___plugincommand) \
   LP1NR(0x2a, Commandplugin, struct Plugincommand *, ___plugincommand, a0,\
   , (___base), IF_CACHEFLUSHALL, NULL, 0, IF_CACHEFLUSHALL, NULL, 0)

#define Filterplugin(___pf) __Filterplugin_WB(AWEBPLUGIN_BASE_NAME, ___pf)
#define __Filterplugin_WB(___base, ___pf) \
   LP1NR(0x30, Filterplugin, struct Pluginfilter *, ___pf, a0,\
   , (___base), IF_CACHEFLUSHALL, NULL, 0, IF_CACHEFLUSHALL, NULL, 0)
