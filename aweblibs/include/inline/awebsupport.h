...
#define __AmethodA_WB(___base, ___par1, ___tags) \
        LP2(0x1e, ULONG, AmethodA , struct Aobject *, ___par1, a0, struct Amessage *, ___tags, a1, ,(___base)\
)
...
#define __Amethod_WB(___base, ___par1, ___dummy, ...) \
        ({ULONG _message[] = { (ULONG) ___dummy, ## __VA_ARGS__ }; __AmethodA_WB((___base), (___par1), (struct Amessage *) _message); })
...
#define __AmethodasA_WB(___base, ___par1, ___par2, ___tags) \
        LP3(0x24, ULONG, AmethodasA , ULONG, ___par1, d0, struct Aobject *, ___par2, a0, struct Amessage *, ___tags, a1, ,(___base)\
)
...
#define __Amethodas_WB(___base, ___par1, ___par2, ___dummy, ...) \
        ({ULONG _message[] = { (ULONG) ___dummy, ## __VA_ARGS__ }; __AmethodasA_WB((___base), (___par1), (___par2), (struct Amessage *) _message); })
#endif /* !NO_INLINE_VARARGS */
...
#define __AnewobjectA_WB(___base, ___par1, ___tags) \
        LP2(0x2a, APTR, AnewobjectA , ULONG, ___par1, d0, struct TagItem *, ___tags, a0, ,(___base)\
)
...
#define __Anewobject_WB(___base, ___par1, ___dummy, ...) \
        ({ULONG _tags[] = { (ULONG) ___dummy, ## __VA_ARGS__ }; __AnewobjectA_WB((___base), (___par1), (struct TagItem *) _tags); })
...
#define __Adisposeobject_WB(___base, ___last) \
        LP1NR(0x30, Adisposeobject , struct Aobject *, ___last, a0, ,(___base)\
)
...
#define __AsetattrsA_WB(___base, ___par1, ___tags) \
        LP2(0x36, ULONG, AsetattrsA , struct Aobject *, ___par1, a0, struct TagItem *, ___tags, a1, ,(___base)\
)
...
#define __Asetattrs_WB(___base, ___par1, ___dummy, ...) \
        ({ULONG _tags[] = { (ULONG) ___dummy, ## __VA_ARGS__ }; __AsetattrsA_WB((___base), (___par1), (struct TagItem *) _tags); })
#endif /* !NO_INLINE_STDARG */
...
#define __AgetattrsA_WB(___base, ___par1, ___tags) \
        LP2(0x3c, ULONG, AgetattrsA , struct Aobject *, ___par1, a0, struct TagItem *, ___tags, a1, ,(___base)\
)
...
#define __Agetattrs_WB(___base, ___par1, ___dummy, ...) \
        ({ULONG _tags[] = { (ULONG) ___dummy, ## __VA_ARGS__ }; __AgetattrsA_WB((___base), (___par1), (struct TagItem *) _tags); })
#endif /* !NO_INLINE_STDARG */
...
#define __Agetattr_WB(___base, ___par1, ___last) \
        LP2(0x42, ULONG, Agetattr , struct Aobject *, ___par1, a0, ULONG, ___last, d0, ,(___base)\
)
...
#define __AupdateattrsA_WB(___base, ___par1, ___par2, ___tags) \
        LP3(0x48, ULONG, AupdateattrsA , struct Aobject *, ___par1, a0, struct TagItem *, ___par2, a1, struct TagItem *, ___tags, a2, ,(___base)\
)
...
#define __Aupdateattrs_WB(___base, ___par1, ___par2, ___dummy, ...) \
        ({ULONG _tags[] = { (ULONG) ___dummy, ## __VA_ARGS__ }; __AupdateattrsA_WB((___base), (___par1), (___par2), (struct TagItem *) _tags); })
#endif /* !NO_INLINE_STDARG */
...
#define __Arender_WB(___base, ___par1, ___par2, ___par3, ___par4, ___par5, ___par6, ___par7, ___last) \
        LP8(0x4e, ULONG, Arender , struct Aobject *, ___par1, a0, struct Coords *, ___par2, a1, LONG, ___par3, d0, LONG, ___par4, d1, LONG, ___par5, d2, LONG, ___par6, d3, USHORT, ___par7, d4, APTR, ___last, a2, ,(___base)\
)
...
#define __Aaddchild_WB(___base, ___par1, ___par2, ___last) \
        LP3(0x54, ULONG, Aaddchild , struct Aobject *, ___par1, a0, struct Aobject *, ___par2, a1, ULONG, ___last, d0, ,(___base)\
)
...
#define __Aremchild_WB(___base, ___par1, ___par2, ___last) \
        LP3(0x5a, ULONG, Aremchild , struct Aobject *, ___par1, a0, struct Aobject *, ___par2, a1, ULONG, ___last, d0, ,(___base)\
)
...
#define __Anotify_WB(___base, ___par1, ___last) \
        LP2(0x60, ULONG, Anotify , struct Aobject *, ___par1, a0, struct Amessage *, ___last, a1, ,(___base)\
)
...
#define __Allocobject_WB(___base, ___par1, ___par2, ___last) \
        LP3(0x66, APTR, Allocobject , ULONG, ___par1, d0, LONG, ___par2, d1, struct Amset *, ___last, a0, ,(___base)\
)
...
#define __AnotifysetA_WB(___base, ___par1, ___tags) \
        LP2(0x6c, ULONG, AnotifysetA , struct Aobject *, ___par1, a0, struct TagItem *, ___tags, a1, ,(___base)\
)
...
#define __Anotifyset_WB(___base, ___par1, ___dummy, ...) \
        ({ULONG _tags[] = { (ULONG) ___dummy, ## __VA_ARGS__ }; __AnotifysetA_WB((___base), (___par1), (struct TagItem *) _tags); })
#endif /* !NO_INLINE_STDARG */
...
#define __Allocmem_WB(___base, ___par1, ___last) \
        LP2(0x72, APTR, Allocmem , ULONG, ___par1, d0, ULONG, ___last, d1, ,(___base)\
)
...
#define __Dupstr_WB(___base, ___par1, ___last) \
        LP2(0x78, STRPTR, Dupstr , STRPTR, ___par1, a0, LONG, ___last, d0, ,(___base)\
)

#define Freemem(___last) __Freemem_WB(AWEBSUPPORT_BASE_NAME, ___last)
#define __Freemem_WB(___base, ___last) \
        LP1NR(0x7e, Freemem , APTR, ___last, a0, ,(___base)\
)
...
#define __Clipcoords_WB(___base, ___par1, ___last) \
        LP2(0x84, struct Coords *, Clipcoords , struct Aobject *, ___par1, a0, struct Coords *, ___last, a1, ,(___base)\
)

#define Unclipcoords(___last) __Unclipcoords_WB(AWEBSUPPORT_BASE_NAME, ___last)
#define __Unclipcoords_WB(___base, ___last) \
        LP1NR(0x8a, Unclipcoords , struct Coords *, ___last, a0, ,(___base)\
)
...
#define __Erasebg_WB(___base, ___par1, ___par2, ___par3, ___par4, ___par5, ___last) \
        LP6NR(0x90, Erasebg , struct Aobject *, ___par1, a0, struct Coords *, ___par2, a1, LONG, ___par3, d0, LONG, ___par4, d1, LONG, ___par5, d2, LONG, ___last, d3, ,(___base)\
)

#define Aweb() __Aweb_WB(AWEBSUPPORT_BASE_NAME)
#define __Aweb_WB(___base) \
        LP0(0x96, struct Aobject *, Aweb , ,(___base)\
)
...
#define __AsetattrsasyncA_WB(___base, ___par1, ___tags) \
        LP2NR(0x9c, AsetattrsasyncA , struct Aobject *, ___par1, a0, struct TagItem *, ___tags, a1, ,(___base)\
)
...
#define __UpdatetaskattrsA_WB(___base, ___tags) \
        LP1(0xc0, ULONG, UpdatetaskattrsA , struct TagItem *, ___tags, a0, ,(___base)\
)
...
#define __Updatetaskattrs_WB(___base, ___tags, ...) \
        ({ULONG _tags[] = { (ULONG) ___tags, ## __VA_ARGS__ }; __UpdatetaskattrsA_WB((___base), (struct TagItem *) _tags); })
#endif /* !NO_INLINE_STDARG */
...
#define __Obtaintasksemaphore_WB(___base, ___last) \
        LP1(0xc6, ULONG, Obtaintasksemaphore , struct SignalSemaphore *, ___last, a0, ,(___base)\
)
...
#define __Avprintf_WB(___base, ___par1, ___last) \
        LP2(0xcc, LONG, Avprintf , char *, ___par1, a0, ULONG *, ___last, a1, ,(___base)\
)
...
#define __Awebstr_WB(___base, ___last) \
        LP1(0xd2, UBYTE *, Awebstr , ULONG, ___last, d0, ,(___base)\
)
...
#define __TcperrorA_WB(___base, ___par1, ___par2, ___tags) \
        LP3NR(0xd8, TcperrorA , struct Fetchdriver *, ___par1, a0, ULONG, ___par2, d0, ULONG *, ___tags, a1, ,(___base)\
)
...
#define __TcpmessageA_WB(___base, ___par1, ___par2, ___tags) \
        LP3NR(0xde, TcpmessageA , struct Fetchdriver *, ___par1, a0, ULONG, ___par2, d0, ULONG *, ___tags, a1, ,(___base)\
)
...
#define __Opentcp_WB(___base, ___par1, ___par2, ___last) \
        LP3(0xe4, struct Library *, Opentcp , struct Library **, ___par1, a0, struct Fetchdriver *, ___par2, a1, BOOL, ___last, d0, ,(___base)\
)
...
#define __Lookup_WB(___base, ___par1, ___last) \
        LP2(0xea, struct hostent *, Lookup , UBYTE *, ___par1, a0, struct Library *, ___last, a1, ,(___base)\
)
...
#define __Expandbuffer_WB(___base, ___par1, ___last) \
        LP2(0xf0, BOOL, Expandbuffer , struct Buffer *, ___par1, a0, long, ___last, d0, ,(___base)\
)
...
#define __Insertinbuffer_WB(___base, ___par1, ___par2, ___par3, ___last) \
        LP4(0xf6, BOOL, Insertinbuffer , struct Buffer *, ___par1, a0, UBYTE *, ___par2, a1, long, ___par3, d0, long, ___last, d1, ,(___base)\
)
...
#define __Addtobuffer_WB(___base, ___par1, ___par2, ___last) \
        LP3(0xfc, BOOL, Addtobuffer , struct Buffer *, ___par1, a0, UBYTE *, ___par2, a1, long, ___last, d0, ,(___base)\
)
...
#define __Deleteinbuffer_WB(___base, ___par1, ___par2, ___last) \
        LP3NR(0x102, Deleteinbuffer , struct Buffer *, ___par1, a0, long, ___par2, d0, long, ___last, d1, ,(___base)\
)

#define Freebuffer(___last) __Freebuffer_WB(AWEBSUPPORT_BASE_NAME, ___last)
#define __Freebuffer_WB(___base, ___last) \
        LP1NR(0x108, Freebuffer , struct Buffer *, ___last, a0, ,(___base)\
)

#define Locale() __Locale_WB(AWEBSUPPORT_BASE_NAME)
#define __Locale_WB(___base) \
        LP0(0x10e, struct Locale *, Locale , ,(___base)\
)
...
#define __Lprintdate_WB(___base, ___par1, ___par2, ___last) \
        LP3(0x114, long, Lprintdate , UBYTE *, ___par1, a0, UBYTE *, ___par2, a1, struct DateStamp *, ___last, a2, ,(___base)\
)
...
#define __Obtainbgrp_WB(___base, ___par1, ___par2, ___par3, ___par4, ___par5, ___last) \
        LP6(0x11a, struct RastPort *, Obtainbgrp , struct Aobject *, ___par1, a0, struct Coords *, ___par2, a1, LONG, ___par3, d0, LONG, ___par4, d1, LONG, ___par5, d2, LONG, ___last, d3, ,(___base)\
)

#define Releasebgrp(___last) __Releasebgrp_WB(AWEBSUPPORT_BASE_NAME, ___last)
#define __Releasebgrp_WB(___base, ___last) \
        LP1NR(0x120, Releasebgrp , struct RastPort *, ___last, a0, ,(___base)\
)
...
#define __Setstemvar_WB(___base, ___par1, ___par2, ___par3, ___par4, ___last) \
        LP5NR(0x126, Setstemvar , struct Arexxcmd *, ___par1, a0, UBYTE *, ___par2, a1, long, ___par3, d0, UBYTE *, ___par4, a2, UBYTE *, ___last, a3, ,(___base)\
)
...
#define __Addmenuentry_WB(___base, ___par1, ___par2, ___par3, ___par4, ___last) \
        LP5(0x144, struct Menuentry *, Addmenuentry , void *, ___par1, a0, USHORT, ___par2, d0, UBYTE *, ___par3, a1, UBYTE, ___par4, d1, UBYTE *, ___last, a2, ,(___base)\
)

#define Freemimeinfo(___last) __Freemimeinfo_WB(AWEBSUPPORT_BASE_NAME, ___last)
#define __Freemimeinfo_WB(___base, ___last) \
        LP1NR(0x14a, Freemimeinfo , struct Mimeinfo *, ___last, a0, ,(___base)\
)
...
#define __Addmimeinfo_WB(___base, ___par1, ___par2, ___par3, ___par4, ___par5, ___par6, ___last) \
        LP7A4A5(0x150, struct Mimeinfo *, Addmimeinfo , void *, ___par1, a0, UBYTE *, ___par2, a1, UBYTE *, ___par3, a2, UBYTE *, ___par4, a3, USHORT, ___par5, d0, UBYTE *, ___par6, a4, UBYTE *, ___last, d1, ,(___base)\
)

#define Freenocache(___last) __Freenocache_WB(AWEBSUPPORT_BASE_NAME, ___last)
#define __Freenocache_WB(___base, ___last) \
        LP1NR(0x156, Freenocache , struct Nocache *, ___last, a0, ,(___base)\
)
...
#define __Addnocache_WB(___base, ___par1, ___last) \
        LP2(0x15c, struct Nocache *, Addnocache , void *, ___par1, a0, UBYTE *, ___last, a1, ,(___base)\
)
...
#define __Getstemvar_WB(___base, ___par1, ___par2, ___par3, ___last) \
        LP4(0x162, UBYTE *, Getstemvar , struct Arexxcmd *, ___par1, a0, UBYTE *, ___par2, a1, long, ___par3, d0, UBYTE *, ___last, a2, ,(___base)\
)
...
#define __Freeuserbutton_WB(___base, ___last) \
        LP1NR(0x168, Freeuserbutton , struct Userbutton *, ___last, a0, ,(___base)\
)
...
#define __Adduserbutton_WB(___base, ___par1, ___par2, ___last) \
        LP3(0x16e, struct Userbutton *, Adduserbutton , void *, ___par1, a0, UBYTE *, ___par2, a1, UBYTE *, ___last, a2, ,(___base)\
)

#define Freepopupitem(___last) __Freepopupitem_WB(AWEBSUPPORT_BASE_NAME, ___last)
#define __Freepopupitem_WB(___base, ___last) \
        LP1NR(0x174, Freepopupitem , struct Popupitem *, ___last, a0, ,(___base)\
)
...
#define __Addpopupitem_WB(___base, ___par1, ___par2, ___par3, ___last) \
        LP4(0x17a, struct Popupitem *, Addpopupitem , void *, ___par1, a0, USHORT, ___par2, d0, UBYTE *, ___par3, a1, UBYTE *, ___last, a2, ,(___base)\
)

#define Awebversion() __Awebversion_WB(AWEBSUPPORT_BASE_NAME)
#define __Awebversion_WB(___base) \
        LP0(0x180, UBYTE *, Awebversion , ,(___base)\
)
...
#define __Syncrequest_WB(___base, ___par1, ___par2, ___last) \
        LP3(0x186, long, Syncrequest , UBYTE *, ___par1, a0, UBYTE *, ___par2, a1, UBYTE *, ___last, a2, ,(___base)\
)
...
#define __PprintfA_WB(___base, ___par1, ___par2, ___tags) \
        LP3(0x18c, UBYTE *, PprintfA , UBYTE *, ___par1, a0, UBYTE *, ___par2, a1, UBYTE **, ___tags, a2, ,(___base)\
)
...
#define __Adduserkey_WB(___base, ___par1, ___par2, ___last) \
        LP3(0x19e, struct Userkey *, Adduserkey , void *, ___par1, a0, USHORT, ___par2, d0, UBYTE *, ___last, a1, ,(___base)\
)
...
#define __LprintfA_WB(___base, ___par1, ___par2, ___tags) \
        LP3(0x1a4, long, LprintfA , UBYTE *, ___par1, a0, UBYTE *, ___par2, a1, void *, ___tags, a2, ,(___base)\
)
...
#define __Lprintf_WB(___base, ___par1, ___par2, ___dummy, ...) \
        ({ULONG _message[] = { (ULONG) ___dummy, ## __VA_ARGS__ }; __LprintfA_WB((___base), (___par1), (___par2), (void *) _message); })
#endif /* !NO_INLINE_VARARGS */

#define Fullversion() __Fullversion_WB(AWEBSUPPORT_BASE_NAME)
#define __Fullversion_WB(___base) \
        LP0(0x1aa, BOOL, Fullversion , ,(___base)\
)
...
#define __Setfiltertype_WB(___base, ___par1, ___last) \
        LP2NR(0x1b0, Setfiltertype , void *, ___par1, a0, UBYTE *, ___last, a1, ,(___base)\
)
...
#define __Writefilter_WB(___base, ___par1, ___par2, ___last) \
        LP3NR(0x1b6, Writefilter , void *, ___par1, a0, UBYTE *, ___par2, a1, long, ___last, d0, ,(___base)\
)
...
#define __Addfontalias_WB(___base, ___par1, ___last) \
        LP2(0x1ce, struct Fontalias *, Addfontalias , void *, ___par1, a0, UBYTE *, ___last, a1, ,(___base)\
)

#define Freestemvar(___last) __Freestemvar_WB(AWEBSUPPORT_BASE_NAME, ___last)
#define __Freestemvar_WB(___base, ___last) \
        LP1NR(0x1d4, Freestemvar , UBYTE *, ___last, a0, ,(___base)\
)
